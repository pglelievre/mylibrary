...
public class FileUtils {
    ...
    /** Provides everything but the path of a file (name plus extension).
     * @param f The input file.
     * @return Everything but the path of a file (name plus extension).
     */
    public static String getNameExt(File f) {
        return f.getName();
    }
